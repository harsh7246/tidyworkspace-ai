...
5. Pick a provider (Gemini / OpenAI / Claude / DeepSeek), paste your API key, click **Test connection**, then **Save**.
6. Both pipelines are on by default. Toggle them from the popup or settings.

## Notes

- **No data leaves your machine except to the provider you choose**, using your own key. Nothing is sent to any TidyWorkspace-run server (there isn't one).
